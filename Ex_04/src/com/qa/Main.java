...
public class Main {
    public static void main(String[] args) {
        ...
        System.out.println();
        System.out.println("circle1 location before " + c1.getCurrentLocation());
        System.out.println("NOW we start moving the circle ..........................");
        c1.move(4.5, 6);
        System.out.println("circle1 location after " + c1.getCurrentLocation());
